...
module.exports = {
    ...
    //superadmin
    //create other admin by superadmin
    ...
    //update status other admin by superadmin from not active to active
    ...
    //get other admin for superadmin
    ...
    //update status self admin to not active 
    ...
    //logout self admin and superadmin
